            ...
            <li class="nav-item dropdown d-flex align-items-center">
                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown"
                   aria-haspopup="true" aria-expanded="false">
                    <span class="flag-icon flag-icon-<?php echo e(Config::get('languages')[App::getLocale()]['flag-icon']); ?>"></span><?php echo e(__('message.language')); ?> :
        ...
        <div class="form-content">
            <form method="POST" class="validate-form" autocomplete="off" action="<?php echo e(route('login')); ?>">
                ...
                <div class="form-group validate-input">
					<label for="username"><?php echo e(__('message.username')); ?></label>
...
unset($__errorArgs, $__bag); ?>
				...
				<label class="form-remember">
					<input id="ckb1" name="remember" type="checkbox" /> <?php echo e(__('message.remember_me')); ?>

				</label>

                </div>
                <div class="form-group">
                    <button type="submit"><?php echo e(__('message.login')); ?></button>
                </div>
                <div class="form-remember pb-3">
					<p style="color: red; text-align: right;"> *** <?php echo e(__('message.forgot_password')); ?></p>
                </div>
                <ul>
				<li><?php echo e(__('message.use_kku_mail')); ?></li>
				<li><?php echo e(__('message.first_time_login')); ?></li>
                </ul>
            </form>
        </div>
    </div>
...
</html><?php /**PATH C:\xampp\htdocs\git-group-repository-group-4\InitialProject\V.0\resources\views/auth/login.blade.php ENDPATH**/ ?>
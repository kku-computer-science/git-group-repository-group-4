...
<div class="container home">
    ...
    <?php $__currentLoopData = $selectedBanners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="carousel-item <?php echo e($index == 0 ? 'active' : ''); ?>">
            <img src="<?php echo e(asset($banner)); ?>" class="d-block w-100" alt="Banner">
        </div>
...
<script>
    ...
    var barChartOptions = {
        ...
        title: {
            display: true,
            text: ' <?php echo e(__("message.total_articles_5_years")); ?>',
            fontSize: 20
        }
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\git-group-repository-group-4\InitialProject\V.0\resources\views/home.blade.php ENDPATH**/ ?>
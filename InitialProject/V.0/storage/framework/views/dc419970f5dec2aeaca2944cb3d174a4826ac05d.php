...
<div class="container card-cart d-sm-flex  justify-content-center mt-5">
    <div class="card">
        <div class="card-body">
            <h5 class="card-title" style="padding: 16px;"><?php echo e(__('message.total_articles_5_years')); ?></h4>
                <div class="row">
...
<div class="container card-cart d-sm-flex  justify-content-center mt-5">
    <div class="card">
        <div class="card-body">
            <h5 class="card-title"  style="padding: 16px;"><?php echo e(__('message.Record the number of articles that have been cited')); ?></h4>
                <div class="row">
                    <div class="col-md-6 p-5">
                        <div style="width:520px;height:250px">
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\git-group-repository-group-4\InitialProject\V.0\resources\views/report.blade.php ENDPATH**/ ?>
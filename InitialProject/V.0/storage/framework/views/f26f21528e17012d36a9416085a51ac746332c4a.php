...
<div class="container cardprofile mt-5">
                    ...
                    <h6 class="card-text"><b><?php echo e($res->fname_en); ?> <?php echo e($res->lname_en); ?>, <?php echo e($res->doctoral_degree); ?> </b>
                        ...
                        <b>
                                    ...
                                    <?php elseif(app()->getLocale() == 'en'): ?>
                                        <?php echo e($res->academic_ranks_en); ?>
    ...
    <?php echo e($edu->year); ?>           
                            ...
                            <?php elseif(app()->getLocale() == 'en'): ?>
                                <?php echo e($edu->qua_name_en); ?> - <?php echo e($edu->uname_en); ?>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        ...
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="patent-tab" data-bs-toggle="tab" data-bs-target="#patent" type="button" role="tab" aria-controls="patent" aria-selected="false"><?php echo e(__('message.journal')); ?></button>
        </li>
    </ul>
    <br>
    <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
            <div class="tab-content" style="padding-bottom: 20px;">
                <a class="btn btn-success" href="<?php echo e(route('excel', ['id' => $res->id])); ?>" target="_blank"><?php echo e(__('message.Excel')); ?></a>
            </div>
            <table id="example1" class="table table-striped" style="width:100%">
                <thead>
                    ...
                    <tr>
                        ...
                        <th><?php echo e(__('message.paper_name')); ?></th>
                        <th><?php echo e(__('message.author')); ?></th>
                        <th><?php echo e(__('message.document_type')); ?></th>
                        <th><?php echo e(__('message.page')); ?></th>
                        <th><?php echo e(__('message.journals_transactions')); ?></th>
                        <th><?php echo e(__('message.citations')); ?></th>
                        <th><?php echo e(__('message.doi')); ?></th>
            ...
            <table id="example2" class="table table-striped" style="width:100%">
                <thead>
                    <tr>
                        <th><?php echo e(__('message.no')); ?></th>
                        <th><?php echo e(__('message.year')); ?></th>
                        <th style="width:90%;"><?php echo e(__('message.paper_name')); ?></th>
                        <th><?php echo e(__('message.author')); ?></th>
                        <th><?php echo e(__('message.document_type')); ?></th>
                        <th style="width:100%;"><?php echo e(__('message.page')); ?></th>
                        <th><?php echo e(__('message.journals_transactions')); ?></th>
                        <th><?php echo e(__('message.citations')); ?></th>
                        <th><?php echo e(__('message.doi')); ?></th>
                    </tr>
        ...
        <div class="tab-pane fade" id="book" role="tabpanel" aria-labelledby="book-tab">
            <table id="example5" class="table table-striped" style="width:100%">
                <thead>
                    <tr>
                    <th scope="col"><?php echo e(__('message.no')); ?></th>
                    <th scope="col"><?php echo e(__('message.year')); ?></th>
                    <th scope="col"><?php echo e(__('message.name')); ?></th>
                    <th scope="col"><?php echo e(__('message.author')); ?></th>
                    <th scope="col"><?php echo e(__('message.place_of_publication')); ?></th>
                    <th scope="col"><?php echo e(__('message.page')); ?></th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php $__currentLoopData = $paper->author; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $author): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <span>
                                <a>aa<?php echo e($author -> author_fname); ?> <?php echo e($author -> author_lname); ?></a>
        ...
        <div class="tab-pane fade" id="patent" role="tabpanel" aria-labelledby="patent-tab">
            ...
            <th scope="col"><?php echo e(__('message.name')); ?></th>
            <th scope="col"><?php echo e(__('message.author')); ?></th>
            <th scope="col"><?php echo e(__('message.type')); ?></th>
            <th scope="col"><?php echo e(__('message.registration_number')); ?></th>
            <th scope="col"><?php echo e(__('message.registration_date')); ?></th>

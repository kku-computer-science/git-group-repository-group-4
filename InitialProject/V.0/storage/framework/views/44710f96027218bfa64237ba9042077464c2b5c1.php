            ...
            <div class="navbar-menu-wrapper d-flex align-items-top">
                <ul class="navbar-nav">
                    <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
                        <h1 class="welcome-text"><?php echo e(__('message.Research Information Management System')); ?> <span
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown d-flex align-items-center">
                        ...
                        aria-haspopup="true" aria-expanded="false">
                            ...
                            <?php echo e(__('message.language')); ?> : <?php echo e(Config::get('languages')[App::getLocale()]['display']); ?>
                ...
                <ul class="nav">
                    <li class="nav-item">
                        <a class="nav-link <?php echo e((request()->is('dashboard*')) ? 'active' : ''); ?>"
                            ...
                            <span class="menu-title"><?php echo e(__('message.dashboard')); ?></span>
                        </a>
                    </li>
                    <li class="nav-item nav-category"><?php echo e(__('message.profile')); ?></li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e((request()->is('admin/profile*')) ? 'active' : ''); ?>"
                            href="<?php echo e(route('profile')); ?>">
                            <i class="menu-icon mdi mdi-account-circle-outline"></i>
                            <span class="menu-title"><?php echo e(__('message.user_profile')); ?></span>
                    ...
                    <li class="nav-item nav-category"><?php echo e(__('message.option')); ?></li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('funds.index')); ?>">
                            ...
                            <span class="menu-title"><?php echo e(__('message.manage_fund')); ?></span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('researchProjects.index')); ?>">
                            ...
                            <span class="menu-title"><?php echo e(__('message.research_project')); ?></span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('researchGroups.index')); ?>">
                            ...
                            <span class="menu-title"><?php echo e(__('message.research_group')); ?></span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#ManagePublications" aria-expanded="false" aria-controls="ManagePublications">
                            ...
                            <span class="menu-title"><?php echo e(__('message.manage_publications')); ?></span>
                            <i class="menu-arrow"></i>
                        </a>
                        <div class="collapse" id="ManagePublications">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="<?php echo e(route('papers.index')); ?>"><?php echo e(__('message.published_research')); ?></a></li>
                                <li class="nav-item"> <a class="nav-link" href="/books"><?php echo e(__('message.book')); ?></a></li>
                                <li class="nav-item"> <a class="nav-link" href="/patents"><?php echo e(__('message.other_scholarly_works')); ?></a></li>
                            </ul>
                        </div>
                    </li>
                    <?php endif; ?>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('exportfile')); ?>" >
                            ...
                            <span class="menu-title"><?php echo e(__('message.export')); ?></span>
                        </a>
                    </li>
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('user-list')): ?>
                    <li class="nav-item nav-category"><?php echo e(__('message.admin')); ?></li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('users.index')); ?>">
                            <i class="menu-icon mdi mdi-account-multiple-outline"></i>
                            <span class="menu-title"><?php echo e(__('message.users')); ?></span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('roles.index')); ?>">
                            ...
                            <span class="menu-title"><?php echo e(__('message.roles')); ?></span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('permissions.index')); ?>">
                            ...
                            <span class="menu-title"><?php echo e(__('message.permission')); ?></span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('departments.index')); ?>">
                            ...
                            <span class="menu-title"><?php echo e(__('message.departments')); ?></span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('programs.index')); ?>">
                            ...
                            <span class="menu-title"><?php echo e(__('message.manage_programs')); ?></span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('experts.index')); ?>">
                            ...
                            <span class="menu-title"><?php echo e(__('message.manage_expertise')); ?></span>
...
</html><?php /**PATH C:\xampp\htdocs\git-group-repository-group-4\InitialProject\V.0\resources\views/dashboards/users/layouts/user-dash-layout.blade.php ENDPATH**/ ?>
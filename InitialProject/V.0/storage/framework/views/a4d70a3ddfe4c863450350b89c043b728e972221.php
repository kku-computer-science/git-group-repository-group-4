        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavbar">
                <ul class="navbar-nav ms-auto navbar-nav-scroll">
                    ...
                    <li class="nav-item <?php echo e(Request::routeIs('researchers') ? 'active' : ''); ?>">
                        <a class="nav-link" href="<?php echo e(route('researchers')); ?>"> 
                ...
                <?php if(Auth::check()): ?> <!-- เช็คการเข้าสู่ระบบ -->
                    <span class="nav-item">
                        <a href="<?php echo e(route('dashboard')); ?>" class="nav-link">Dashboard</a> <!-- แสดงลิงก์ที่ต้องการเมื่อเข้าสู่ระบบ -->
                    </span>
                <?php else: ?>
                    <span class="nav-item">
                        <a class="btn-solid-sm" href="<?php echo e(route('login')); ?>" target="_blank"><?php echo e(__('message.Login')); ?></a>
                    </span>
                <?php endif; ?>
...
</html><?php /**PATH C:\xampp\htdocs\git-group-repository-group-4\InitialProject\V.0\resources\views/layouts/layout.blade.php ENDPATH**/ ?>
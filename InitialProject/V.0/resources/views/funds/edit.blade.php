...
<div class="container">
    ...
    <div class="col-md-8 grid-margin stretch-card">
        <div class="card" style="padding: 16px;">
            <div class="card-body">
                <h4 class="card-title">{{ __('message.edit_fund') }}</h4>
                <p class="card-description">{{ __('message.fill_fund_edit_details') }}</p>
                <form class="forms-sample" action="{{ route('funds.update',$fund->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="form-group row">
                        <p class="col-sm-3 "><b>{{ __('message.fund_type') }}</b></p>
                        <div class="col-sm-4">
                    ...
                    <div id="fund_code">
                        <div class="form-group row">
                            <p class="col-sm-3"><b>{{ __('message.fund_level') }}</b></p>
                            <div class="col-sm-4">
                    ...
                    <div class="form-group row">
                        <p class="col-sm-3 "><b>{{ __('message.fund_name') }}</b></p>
                        <div class="col-sm-8">
                            <input type="text" name="fund_name" value="{{ $fund->fund_name }}" class="form-control" placeholder="{{ __('message.fund_name') }}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <p class="col-sm-3 "><b>{{ __('message.support_resource') }}</b></p>
                        <div class="col-sm-8">
